...
export default function Sidebar({
    ...
    if (collapsed) {
        return (
            <div
                className="relative z-[1000] flex flex-col items-center py-4 gap-3 bg-[var(--glass-bg)] backdrop-blur-xl border-r border-[var(--glass-border)]"
                style={{ width: 48 }}
            >
                <button
        ...
        >
                    ...
                    <>
                        {!selectedZone && !selectedLine && (
                            <div className="p-8 text-center text-sm text-[var(--color-text-muted)] animate-fade-in flex flex-col items-center gap-4">
                                <Map
                                    size={32}
                                    className="text-[var(--color-border-hover)] opacity-50"
                                />
                                <p>
                                    Click on a{" "}
                                    ...
                                    on the map to explore detailed insights and
                                    demographics.
                                </p>
                            </div>
                        )}
            ...
            <div className="px-4 py-2 border-t border-[var(--color-border)]">
                <p className="text-[9px] text-[var(--color-text-muted)] leading-relaxed">
                    Data: City of Toronto Open Data • TTC GTFS & Ridership •
                    2021 Census • Screening-level estimates only
                </p>
            </div>
        </div>
    );
